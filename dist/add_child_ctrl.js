...
System.register(['./utils', 'angular'], function (_export, _context) {
  ...
  function prepareModalData(node, allData) {
    ...
    if (node.type === 'Root') {
      ...
      filter = allData.filter(function (d) {
        return d.category_id !== null && d.category_id === node.info.category && d.reason_id !== null && d.parent_reason_id === null;
      });
      filter = filter.reduce(function (arr, record) {
      ...
      placeholder = 'Enter a Reason here';
      filter = allData.filter(function (d) {
        return d.category_id !== null && d.category_id === node.info.category && d.reason_id !== null && d.parent_reason_id === node.name;
      });
      filter = filter.reduce(function (arr, record) {
        arr.push(record.reason_id);
        return arr;
  ...
  function insertNode(input, node, panelCtrl, allData) {
    ...
    if (!isInputValid(input, node, allData)) {
      return;
    }
