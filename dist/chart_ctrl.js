...
System.register(['lodash', 'jquery', './libs/echarts.min', 'app/plugins/sdk', './tree_option', './tree_convertor', './crud_ctrl', './css/style.css!', './css/input-fields.css!'], function (_export, _context) {
  "use strict";

  var _, $, echarts, MetricsPanelCtrl, generateOption, getTreeStructureData, showCrudPopup, _createClass, _get, panelDefaults, ChartCtrl;
      ...
      _export('ChartCtrl', ChartCtrl = function (_MetricsPanelCtrl) {
        ...
        _createClass(ChartCtrl, [{
          ...
          value: function link(scope, elem, attrs, ctrl) {
            var $panelContainer = elem.find('#reason-code-tree')[0];
